 ...
 public static class PersianTextNormalizer {
        ...
        public static string FixYeKe(this string text) {
            ...
            for (var i = 0; i < dataChars.Length; i++) {
                switch (dataChars[i]) {
                    case PersianTextConstants.ArabicYeChar1:
                    case PersianTextConstants.ArabicYeChar2:
                    case PersianTextConstants.ArabicYeWithOneDotBelow:
                    case PersianTextConstants.ArabicYeWithInvertedV:
                    case PersianTextConstants.ArabicYeWithTwoDotsAbove:
                    case PersianTextConstants.ArabicYeWithThreeDotsAbove:
                    case PersianTextConstants.ArabicYeWithHighHamzeYeh:
                    case PersianTextConstants.ArabicYeWithFinalForm:
                    case PersianTextConstants.ArabicYeWithThreeDotsBelow:
                    case PersianTextConstants.ArabicYeWithTail:
                    case PersianTextConstants.ArabicYeSmallV:
                        dataChars[i] = PersianTextConstants.PersianYeChar;
                        break;

                    case PersianTextConstants.ArabicKeChar:
                        dataChars[i] = PersianTextConstants.PersianKeChar;
                        break;
